...
def conjclasses_unitary_elliptic(n, primes_list, K, verbose=False):
    """
    ...
    exactly like your conjclasses_unitary.
...
def tot_ram_sub_conj_classes_unitary(cc, p):
    ...
    where:
      - m_red is the reduced tame part (with the unitary 2-modification)
